...
export function Evolution(){
   return(
    ...
    <div className="evolutionaryLine h-[350px] m-20 mt-2 ml-10 border-2 rounded-[3vw]" style={{ backgroundColor: UniverseTypeNameToPropertiesConstants.POKEMON.secondaryColor }}></div>
    </>
