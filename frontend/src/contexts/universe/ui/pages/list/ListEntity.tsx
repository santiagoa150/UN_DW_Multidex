type ListEntityProps = {
  ...
  export function ListEntity({ itemNumber,name,type,habitat,creator,imageUrl,}: ListEntityProps) {
    return (
      <div className="w-full sm:w-64 bg-white shadow-lg rounded-2xl overflow-hidden mb-6">
        <img src={imageUrl} alt={name} className="w-full h-48 sm:h-40 object-contain bg-white"/>
        <div className="p-4 text-left sm:ml-5">
          ...
          <button className="mt-2 text-blue-500 font-bold hover:underline  sm:text-right">
            DESCUBRIR MÁS...
          </button>
