    ...
    return (
        <>
            <section>
                ...
                <p style={{backgroundColor: universeType?.indexEdit}} className="text-lg w-32 h-12 flex items-center justify-center font-bold text-black rounded-md justify-start " >
                    {universeEntity?.id}
                </p>
