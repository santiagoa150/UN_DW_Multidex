...
export class HttpUniverseEntity implements UniverseEntityDto {
    ...
    @IsNotEmpty({ message: UniverseExceptionMessagesConstants.UNIVERSE_ENTITY_ID_IS_REQUIRED })
    @IsString({ message: UniverseExceptionMessagesConstants.UNIVERSE_ENTITY_ID_MUST_BE_A_STRING })
    id: string;
